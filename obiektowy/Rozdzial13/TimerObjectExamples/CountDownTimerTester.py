...
WHITE = (255, 255, 255)
TIMER_LENGTH = 5  # Wartość w sekundach.
...
oTimer = pyghelpers.CountDownTimer(TIMER_LENGTH)  # Utworzenie obiektu typu Timer.
...
while True:
    ...
    if oTimer.ended():  # Wartość True oznacza, że zegar zakończył działanie.
        oStartButton.enable()
        oTimerMessage.hide()
